			...
			<div class = "card shadow mb-4">
				...
				<div class = "card-body">
					<form>
						...
						<div class = "mb-3">
							<label class = "form-label" for = "address"><strong>تصویر کالا ( تصویر اصلی )</strong><br></label><input class = "border rounded-pill form-control form-control-sm" type = "file" required = "" accept = "image/*" style = "font-family: Vazir;">
						</div>
						...
						<div class = "row d-grid d-sm-flex justify-content-center align-items-center">
							<div class = "col">
								<div class = "mb-3" style = "position: relative;">
									<label class = "form-label" for = "city"><strong>افزودن تصاویر کالا</strong><br></label>
