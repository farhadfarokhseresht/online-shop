    ...
    <div id="wrapper">
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                </nav><!-- Start: dash add product -->
                <div class="container-fluid" style="direction: rtl;text-align: right;">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4" style="margin-top: 20px;"><strong>افزودن کالای جدید</strong><i class="fas fa-boxes"></i></div>
                                        ...
                                        <div class="row d-grid d-sm-flex">
                                            <div class="col">
                                                <div class="d-grid mb-3" id="categoripart"><label class="form-label" for="country"><strong>دسته</strong></label><select class="form-select" id="catgory">
                                                    ...
                                                    <div class="d-inline-flex align-items-sm-center admin_add_npart_bu" id="admin_add_cat_bu" onclick="addnewcat()"><small class="form-text">افزودن دسته جدید&nbsp;</small><i class="far fa-plus-square"></i></div><script>
function addnewcat(){
	$('#catgory').remove();
	...
	$('#categoripart').append('<input type="text" class="form-control" placeholder="نام دسته جدید" />')
                                            ...
                                            <div class="col">
                                                <div class="d-grid mb-3" id="brandpart"><label class="form-label" for="country"><strong>برند</strong></label><select class="form-select" id="brand">
                                                    ...
                                                    <div class="d-inline-flex align-items-sm-center admin_add_npart_bu" id="admin_add_brand_bu" onclick="addnewbrand()"><small class="form-text">افزودن برند جدید&nbsp;</small><i class="far fa-plus-square"></i></div><script>
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <form>
                                        <div class="row d-grid d-sm-flex justify-content-center align-items-center">
                                            <div class="col">
                                                <div class="mb-3" style="position: relative;"><i class="far fa-images" style="position: absolute;left: 0;top: 2px;"></i><label class="form-label" for="city"><strong>افزودن تصاویر کالا</strong><br></label>
                                                    <div id="new_chq" class="newimage"></div>
                                                    <div class="d-grid"><input class="form-control" type="hidden" id="total_chq" value="1">
                                                        <div class="d-inline-flex align-items-sm-center admin_add_npart_bu" id="addimg"><small class="form-text">افزودن تصویر بیشتر&nbsp;<br></small><i class="far fa-plus-square"></i></div>
                                                        <div class="d-inline-flex align-items-sm-center admin_add_npart_bu" id="removeimg"><small class="form-text">حذف&nbsp;</small><i class="fas fa-trash-alt"></i></div>
                                            ...
                                            <div class="col">
                                                <div class="mb-3" style="position: relative;"><i class="fas fa-tint" style="position: absolute;left: 0;top: 2px;"></i><label class="form-label" for="city"><strong>رنگ</strong><br></label>
                                                    ...
                                                    <div class="d-grid"><input class="form-control" type="hidden" id="total_chq_color" value="1">
                                                        <div class="d-inline-flex align-items-sm-center admin_add_npart_bu" id="addcolor"><small class="form-text">افزودن رنگ بیشتر&nbsp;<br></small><i class="far fa-plus-square"></i></div>
                                                        <div class="d-inline-flex align-items-sm-center admin_add_npart_bu" id="removecolor"><small class="form-text">حذف&nbsp;</small><i class="fas fa-trash-alt"></i></div>
                                                    </div><script>
                                            ...
                                            <div class="col">
                                                <div class="mb-3" style="position: relative;"><i class="far fa-list-alt" style="position: absolute;left: 0;top: 2px;"></i><label class="form-label" for="city"><strong>ویژگی ها</strong><br></label>
                                                    <div id="new_chq_Feature" class="newimage">
                                                        <div class="d-flex align-items-sm-center" id="newfeature"><input class="form-control" type="text" required="" placeholder="ویژگی"><i class="fas fa-paperclip"></i><input class="form-control" type="text" required="" placeholder="مشخصه"></div>
                                                    </div>
                                                    <div class="d-grid"><input class="form-control" type="hidden" id="total_chq_Feature" value="1">
                                                        <div class="d-inline-flex align-items-sm-center admin_add_npart_bu" id="addFeature"><small class="form-text">افزودن ویژگی جدید<br></small><i class="far fa-plus-square"></i></div>
                                                        <div class="d-inline-flex align-items-sm-center admin_add_npart_bu" id="removeFeature"><small class="form-text">حذف&nbsp;</small><i class="fas fa-trash-alt"></i></div>
<script>
