	...
	<nav class="navbar navbar-light align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0" style="background: var(--bs-dark);">
		<div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0">
			...
			<ul class="navbar-nav text-light" id="accordionSidebar">
				<li class="nav-item"><a class="nav-link" href="admin.html"><i class="fas fa-poll"></i><span>داشبرد</span></a><a class="nav-link" href="admin.html"><i class="fas fa-file-invoice"></i><span>تبلیغات صفحه اصلی</span></a></li>
				...
				<li class="nav-item"><a class="nav-link" href="admin-add-product.html"><i class="fas fa-plus-circle"></i><span>افزودن کالای جدید</span></a></li>
				<li class="nav-item"><a class="nav-link" href="#"><i class="fas fa-donate"></i><span>تخفیفات</span></a></li>
				<hr class="sidebar-divider">
				<div class="sidebar-heading">
					<p class="mb-0">مدیریت کاربران&nbsp;</p>
				</div>
				<li class="nav-item"><a class="nav-link" href="admin-user-list.html"><i class="fas fa-users"></i><span>لیست کاربران</span></a><a class="nav-link" href="admin-user-list.html"><i class="fas fa-sms"></i><span>ارسال پیامک به کاربران</span></a></li>
				<hr class="sidebar-divider">
				<div class="sidebar-heading">
