        ...
        <div class="col-lg-4">
            <div class="card mb-3">
                <div class="card-body text-center shadow"><i class="far fa-user" style="font-size: 60px;"></i>
                    <div class="mb-3">
                        <!-- Start: user name -->
                        <h5 id="profile_username">Heading</h5>
                        <!-- End: user name -->
                    </div><a class="card-link" href="#" style="position: relative;"><i class="far fa-envelope" style="font-size: 20px;"></i><small class="mybadage_p">5</small></a>
                </div>
            </div>
                ...
                <div class="card-body d-grid" style="overflow: hidden;max-height: 500px;height: 315px;">
                    ...
                    <div class="d-xxl-flex justify-content-xxl-center align-items-xxl-start new-product-vslid" style="height: 116px;">
                        ...
                        <div class="swiper-wrapper" style="height: 90px;">
                            <!-- Start: Slide -->
                            <div class="swiper-slide" style="height: 97px;"><a href="#" style="margin-bottom: 8px;">
                                    <div class="border rounded d-flex align-items-center m-auto" id="profile_les_p_div"><span class="profile_les_p_name">name</span><img class="rounded order-first" src="assets/img/product%20image/WhatsApp%20Image%202021-01-20%20at%207.12.54%20PM.png" style="max-height: 70px;margin-right: 10px;"><span class="profile_les_p_percent">20%</span><span style="margin-right: 50px;margin-top: 20px;">100000</span><span style="margin-top: 30px;">تومان</span></div>
                                </a></div>
                            <!-- End: Slide -->
                    ...
                    <div class="card shadow mb-3">
                        ...
                        <div class="card-body"  id="address-body" style="display:none;">
                            <form>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="mb-3"><label class="form-label" for="city"><strong>استان</strong></label><input class="form-control" type="text" id="city"></div>
                                    </div>
                                    <div class="col">
                                        <div class="mb-3"><label class="form-label" for="country"><strong>شهر</strong></label><input class="form-control" type="text" id="country"></div>
                                    </div>
                                </div><!-- End: provice and city -->
                                <!-- Start: plak vahed -->
                                <div class="row">
                                    <div class="col-2">
                                        <div class="mb-3"><label class="form-label" for="city"><strong>پلاک</strong></label><input class="form-control" type="text" id="city-1"></div>
                                    </div>
                                    <div class="col-2">
                                        <div class="mb-3"><label class="form-label" for="country"><strong>واحد</strong></label><input class="form-control" type="text" id="country-2"></div>
                                    </div>
                                    <div class="col">
                                        <div class="mb-3"><label class="form-label" for="country"><strong>کد پستی</strong></label><input class="form-control" type="text"></div>
                                    </div>
                                </div><!-- End: plak vahed -->
                                <div class="row">
                                    <div class="col">
                                        <div class="mb-3"><label class="form-label" for="country"><strong>کد ملی</strong></label><input class="form-control" type="text" id="country-1"></div>
                                    </div>
                                    <div class="col">
                                        <div class="mb-3"><label class="form-label" for="country"><strong>شماره مبایل</strong></label><input class="form-control" type="text" id="country-3"></div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col">
                                        <div class="mb-3"><label class="form-label" for="country"><strong>نام گیرنده</strong></label><input class="form-control" type="text" id="country-4"></div>
                                    </div>
                                    <div class="col">
                                        <div class="mb-3"><label class="form-label" for="country"><strong>نام خانوادگی گیرنده</strong></label><input class="form-control" type="text" id="country-3"></div>
                                    </div>
                                </div>
                                <div class="mb-3"><button class="btn btn-primary btn-sm" type="submit">تغییر اطلاعات</button></div>
                            </form>
                                    ...
                                    <form style="margin-top: 10px;">
                                        <div class="table-responsive">
                                            <table class="table table-bordered">
                                                ...
                                                <tr>
                                                    <td>1</td>
                                                    <td class="tiketsub">225452<a class="d-inline-flex" style="margin-right: 5px;"><i class="fas fa-clipboard-list"></i><small>مشاهده فاکتور<br></small></a></td>
        ...
        <div class="card-body" id="tiket-body" style="display: none;">
            <div class="row">
                ...
                <div class="col-auto"><span>ارسال تیکت&nbsp;</span>
                    <form style="margin-top: 10px;">
                        <div class="mb-3"><label class="form-label" for="signature"><strong>موضوع</strong><br></label><input class="form-control" type="text"></div>
                        <div class="mb-3"><label class="form-label" for="signature"><strong>متن پیام</strong><br></label><textarea class="form-control" id="signature" rows="4" name="signature"></textarea></div>
                        <div class="mb-3">
                            <div class="form-check form-switch"><input class="form-check-input" type="checkbox" id="formCheck-1"><label class="form-check-label" for="formCheck-1"><strong>به من پیام بده وقتی تیکتم پاسخ داده شد !</strong><br></label></div>
                        </div>
                        <div class="mb-3"><button class="btn btn-primary btn-sm" type="submit">ارسال</button></div>
                    </form>
                </div><!-- End: sen tiket -->
                <!-- Start: get tiket -->
